  ...
  introjs(session = session, 
          options = list(steps =
                           data.frame(
                             ...
                             intro = c("Before we start looking at bar charts, let's take a tour of our app!", 
                                       "We provide three examples of bar chart races in the sidebar: COVID-19, top brands and, most downloaded R packages. In addition, it is possible to upload your data set.",
                                       "For the COVID-19 example, you can select the outcome: confirmed cases or deaths.",
